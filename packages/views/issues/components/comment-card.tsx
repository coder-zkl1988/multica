            ...
            <>
              ...
              <div className="border-t border-border/50 px-4 max-md:px-3 py-2.5">
                <ReplyInput
                  ...
                  onSubmit={(content, attachmentIds, suppressAgentIds, designRequest, conciseMode) => replyTargetMissing ? Promise.resolve(false) : onReply(replyTargetId, content, attachmentIds, suppressAgentIds, designRequest, conciseMode)}

...
vi.mock("@multica/core/paths", async (importOriginal) => ({
  ...
  useWorkspacePaths: () => ({
    ...
    // Fork-only workspace pages; WORKSPACE_PAGES is the source of truth for
    // the palette, so the mock has to answer for every page it lists.
    products: () => "/ws-test/products",

...
const PAGE_KEYWORDS: Record<WorkspacePageKey, string[]> = {
  ...
  products: ["products", "product", "roadmap", "产品", "产品地图"],
  projects: ["projects", "kanban", "项目"],
  pmo: ["pmo", "sync", "jira", "project management", "项目管理", "同步"],
  designs: ["designs", "design", "ui", "prototype", "设计", "原型", "设计中心"],
  tests: ["tests", "test", "qa", "cases", "测试", "用例"],

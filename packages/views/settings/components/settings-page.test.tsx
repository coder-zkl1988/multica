...
describe("SettingsPage information architecture", () => {
  it("groups workspace configuration and keeps retired pages out of navigation", () => {
    ...
    // Only Labs is retired here. Issue, Chat and GitHub are this fork's own
    // settings tabs and keep their navigation entries; upstream folded its
    // versions of those pages into Preferences and Integrations.
    expect(
      within(nav).queryByRole("link", { name: /^Labs$/ }),
    ).not.toBeInTheDocument();
  });

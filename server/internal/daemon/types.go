...
type TaskResult struct {
	...
	// Legacy inline payload retained for already-queued V1 tasks.
	ProjectDesignSystemArtifacts *ProjectDesignSystemArtifacts `json:"-"`
	// V2 package receipt produced only after archive audit and browser preview.
	ProjectDesignSystemPackage *ProjectDesignSystemPackageReceipt `json:"-"`
}

...
func (c *Client) CompleteTask(ctx context.Context, taskID, output, branchName, sessionID, workDir string, artifacts *ProjectDesignSystemArtifacts, pkg *ProjectDesignSystemPackageReceipt, sessionRolloutMissing bool, retiredSessionID string) error {

...
func TestCreateIssueRejectsActiveDuplicate(t *testing.T) {
	...
	dbfx.QueryRow(t, `
		...
		VALUES ($1, $2, $3)
		RETURNING id
	`, testWorkspaceID, "Duplicate guard project "+suffix, testUserID).Scan(&projectID)
...
func TestAutopilotDispatchUsesCurrentProjectBinding(t *testing.T) {
	...
	dbfx.QueryRow(t, `
		...
		VALUES ($1, $2, $3)
		RETURNING id::text
	`, testWorkspaceID, "Autopilot stale project A", testUserID).Scan(&projectAID)
	dbfx.QueryRow(t, `
		INSERT INTO project (workspace_id, title, created_by)
		VALUES ($1, $2, $3)
		RETURNING id::text
	`, testWorkspaceID, "Autopilot stale project B", testUserID).Scan(&projectBID)
...
func TestUpdateAutopilotCanSetAndClearProject(t *testing.T) {
	...
	dbfx.QueryRow(t, `
		...
		VALUES ($1, $2, $3)
		RETURNING id::text
	`, testWorkspaceID, "Autopilot update project target", testUserID).Scan(&projectID)

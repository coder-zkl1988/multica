...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"chat_prd_draft":                     workspaceDelete,
	...
	"design_asset":                       workspaceDelete,
	"design_catalog_template":            workspaceDelete,
	...
	"design_import_code":                 workspaceDelete,
	"design_plugin_auth_session":         workspaceDelete,
	"design_plugin_token":                workspaceDelete,
	"design_repo_analysis":               workspaceDelete,
	"design_restore_mapping":             workspaceDelete,
	"design_restore_plan":                workspaceDelete,
	"design_restore_task":                workspaceDelete,
	"design_revision":                    workspaceDelete,
	"design_scenario_recipe":             workspaceDelete,
	"design_system_profile":              workspaceDelete,
	"design_template":                    workspaceDelete,
	"design_template_blueprint":          workspaceDelete,
	"design_template_library":            workspaceDelete,
	"design_template_revision":           workspaceDelete,
	"design_template_slot":               workspaceDelete,
	...
	"open_design_run":                    workspaceDelete,
	...
	"pmo_sync_config":                    workspaceDelete,
	"pmo_sync_link":                      workspaceDelete,
	"pmo_sync_run":                       workspaceDelete,
	"product_editors":                    workspaceDelete,
	"product_nodes":                      workspaceDelete,
	"product_refs":                       workspaceDelete,
	"project":                            workspaceDelete,
	"project_design_system":              workspaceDelete,
	"project_design_system_package":      workspaceDelete,
	...
	"service_account_token":              workspaceDelete,
	...
	"test_generation_job":                workspaceDelete,
	"test_generation_plan":               workspaceDelete,
	"test_plan":                          workspaceDelete,
	"test_plan_case":                     workspaceDelete,
	"test_run":                           workspaceDelete,
	"test_run_case":                      workspaceDelete,

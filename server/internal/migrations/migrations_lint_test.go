...
// Bumped from 449 with the upstream/main sync that brought migration 450.
const lastUpstreamMigrationPrefix = 450
...
var mergedDuplicateMigrationStems = map[string][]string{
	...
	"911": {"911_task_run_evidence", "911_test_run_case_agent_task", "911_workspace_repository_identity"},
	"912": {"912_task_run_evidence_task_attempt_index", "912_test_run_case_agent_task_index", "912_workspace_repository_design_scope"},
	"913": {"913_agent_task_execution_metrics", "913_idx_project_design_system_workspace_repository", "913_task_pending_input"},
	"914": {"914_idx_design_file_workspace_repository", "914_prd_draft", "914_task_pending_input_id_index"},
	"915": {"915_idx_design_document_workspace_repository", "915_prd_draft_topic_index", "915_task_pending_input_request_index"},
	"916": {"916_comment_design_delivery", "916_task_pending_input_issue_index", "916_test_run_parallelism"},
	"917": {"917_agent_runtime_test_host", "917_comment_design_delivery_request", "917_task_run_evidence_claim_generation"},
	"918": {"918_autopilot_test_run", "918_design_document_live_preview", "918_task_run_evidence_claim_generation_index"},
	"919": {"919_autopilot_run_test_run_index", "919_design_document_live_preview_task", "919_drop_task_run_evidence_task_attempt_index"},
}

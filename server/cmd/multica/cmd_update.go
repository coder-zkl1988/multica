...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	// Fork builds always update from the fork release. Falling back to the
	// upstream Homebrew tap would replace the SSO-enabled binary with the
	// official build.
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check https://github.com/coder-zkl1988/multica/releases")
	}

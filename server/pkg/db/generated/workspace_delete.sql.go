...
const deleteWorkspaceDesignAssetData = `-- name: DeleteWorkspaceDesignAssetData :exec
WITH
...
func (q *Queries) DeleteWorkspaceDesignAssetData(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDesignAssetData, workspaceID)
	return err
}
...
func (q *Queries) DeleteWorkspaceDesignDependents(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDesignDependents, workspaceID)
	return err
}

const deleteWorkspaceDesignIntegrationData = `-- name: DeleteWorkspaceDesignIntegrationData :exec
WITH
...
func (q *Queries) DeleteWorkspaceDesignIntegrationData(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDesignIntegrationData, workspaceID)
	return err
}

const deleteWorkspaceDesignRoots = `-- name: DeleteWorkspaceDesignRoots :exec
WITH
...
func (q *Queries) DeleteWorkspaceDesignRoots(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDesignRoots, workspaceID)
	return err
}

const deleteWorkspaceDesignTemplateData = `-- name: DeleteWorkspaceDesignTemplateData :exec
WITH
...
func (q *Queries) DeleteWorkspaceDesignTemplateData(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceDesignTemplateData, workspaceID)
	return err
}
...
const prepareWorkspaceDesignDeletionLinks = `-- name: PrepareWorkspaceDesignDeletionLinks :exec
WITH
detached_files AS (
    UPDATE design_file
...
func (q *Queries) PrepareWorkspaceDesignDeletionLinks(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, prepareWorkspaceDesignDeletionLinks, workspaceID)
	return err
}

...
// claudeTokens returns a pointer to v. This fork parses Claude's usage counts
// as *int64 so an absent count stays distinguishable from a reported zero.
func claudeTokens(v int64) *int64 { return &v }
...
func TestClaudeExecuteFallbackUsage(t *testing.T) {
	...
	usage := &claudeUsage{InputTokens: claudeTokens(100), OutputTokens: claudeTokens(1), CacheReadInputTokens: claudeTokens(200), CacheCreationInputTokens: claudeTokens(10)}
	secondUsage := &claudeUsage{InputTokens: claudeTokens(30), OutputTokens: claudeTokens(1), CacheReadInputTokens: claudeTokens(60), CacheCreationInputTokens: claudeTokens(5)}
	blockIndex := 0
	...
	finalUsage := map[string]claudeResultModelUsage{
		model:      {InputTokens: claudeTokens(150), OutputTokens: claudeTokens(50), CacheReadInputTokens: claudeTokens(300), CacheCreationInputTokens: claudeTokens(15)},
		otherModel: {InputTokens: claudeTokens(20), OutputTokens: claudeTokens(10), CacheReadInputTokens: claudeTokens(40), CacheCreationInputTokens: claudeTokens(2)},
	}
	...
	cases := []struct {
		...
		{name: "zero_usage_arrives_before_real_usage", events: []json.RawMessage{assistant("msg_a", model, "", &claudeUsage{OutputTokens: claudeTokens(1)}), a, a2}, want: baseWant},
		{name: "cache_only_response", events: []json.RawMessage{assistant("msg_cache", model, "", &claudeUsage{CacheReadInputTokens: claudeTokens(200), CacheCreationInputTokens: claudeTokens(10)}), assistant("msg_cache", model, "", &claudeUsage{CacheReadInputTokens: claudeTokens(200), CacheCreationInputTokens: claudeTokens(10)})}, want: map[string]TokenUsage{model: {CacheReadTokens: 200, CacheWriteTokens: 10}}},
		...
		{name: "placeholder_output_alone_is_not_usage", events: []json.RawMessage{assistant("msg_a", model, "", &claudeUsage{OutputTokens: claudeTokens(1)})}, want: map[string]TokenUsage{}},
		{name: "successful_model_totals_override_fallback", events: split, result: terminal(false, &claudeUsage{InputTokens: claudeTokens(999)}, finalUsage), success: true, want: finalWant},
		{name: "failed_model_totals_override_fallback", events: split, result: terminal(true, &claudeUsage{InputTokens: claudeTokens(999)}, finalUsage), want: finalWant},
		{name: "terminal_usage_without_model_totals", events: split, result: terminal(true, &claudeUsage{InputTokens: claudeTokens(150), OutputTokens: claudeTokens(50), CacheReadInputTokens: claudeTokens(300), CacheCreationInputTokens: claudeTokens(15)}, nil), want: map[string]TokenUsage{model: finalWant[model]}},
	}

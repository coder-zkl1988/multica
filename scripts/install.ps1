...
#   irm https://raw.githubusercontent.com/coder-zkl1988/multica/main/scripts/install.ps1 | iex
#
# Self-host: starts a local Multica server + installs CLI + configures
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/coder-zkl1988/multica/main/scripts/install.ps1 | iex
#
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/coder-zkl1988/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/coder-zkl1988/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}

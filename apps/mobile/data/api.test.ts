...
// client-identity reads react-native's Platform, and this node-only runner
// cannot parse React Native's Flow sources. The client only reads these two
// values to fill request headers.
